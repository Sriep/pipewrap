...
void WorkflowTreeView::nextCommand()
{
    ...
    else
    {
        ...
        process->start("./command_script.sh");
        currentCommand++;
    }
}
...
QList<QStandardItem*> WorkflowTreeView::snipRows(QModelIndexList indexList)
{
    ...
    if (UsageType == StructureUsageRole ||  UsageType == ToolUsageRole)
    {
        ...
        indexClipboard = index;
        return item_clipboard;
    }
    else
    {
...
bool WorkflowTreeView::insertRows(QList<QStandardItem*>)
{
    return false;
}
...
void WorkflowTreeView::pasteSlot()
{
    ...
    //int clipUT = item_clipboard[0]->data(UsageRole).toInt();
    //if (clipUT == DataUsageRole || clipUT == LabelUsageRole)
    //{
